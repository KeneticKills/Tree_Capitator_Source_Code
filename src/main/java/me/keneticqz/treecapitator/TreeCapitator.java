...
import me.keneticqz.treecapitator.events.PlayerBreakLogEvents;
import me.keneticqz.treecapitator.events.PlayerChangeSlot;
import me.keneticqz.treecapitator.events.PlayerLogin;
...
public final class TreeCapitator extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        pluginManager.registerEvents(new PlayerChangeSlot(sneakData,enableTreeCap),this);
        pluginManager.registerEvents(new PlayerBreakLogEvents(enableTreeCap),this);
        pluginManager.registerEvents(new PlayerLogin(this,sneakData,enableTreeCap),this);
    }
}
